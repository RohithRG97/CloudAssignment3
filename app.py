...
def filteredqueryq11():
    if request.method == "POST":
        ...
        return render_template("filtered_queryq11.html", timetaken = timetaken, data = results, totality_time = totality_time)
...
def redisq12():
    if request.method == "POST":
        ...
        return render_template("time_1000query_redis.html", timetaken = timetaken, data = results, totality_time=totality_time)
